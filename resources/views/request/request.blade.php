            ...
            <div class="card">
                <div class="card-header">
                    <ul class="nav nav-pills card-header-pills">
                        ...
                        <li class="nav-item">
                            <button type="button" class="nav-link btn btn-success mr-1 hvr-bubble-bottom" data-toggle="modal" data-target="#requestModal"><i class="fa fa-plus"></i> Add Request</button>
                        </li>
                    </ul>
                </div>
                <div class="card-body">
                    <h5 class="card-title">List of Request Parameters For <b>{{$route->uri}}</b> Route</h5>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle">Add new Request Field</h5>
            ...
            <div class="modal-body">
                <form action="{{route('requests.store')}}" method="post">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary">Store Request</button>
                    </div>
                </form>
            </div>

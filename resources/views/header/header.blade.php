            ...
            <div class="card">
                <div class="card-header">
                    <ul class="nav nav-pills card-header-pills">
                        ...
                        <li class="nav-item">
                            <button type="button" class="nav-link btn btn-success mr-1 hvr-bubble-bottom" data-toggle="modal" data-target="#headerModal"><i class="fa fa-plus"></i> Add Header</button>
                        </li>
                    </ul>
                </div>
                <div class="card-body">
                    <h5 class="card-title">List of Headers Parameters For <b>{{$route->uri}}</b> Route</h5>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle">Add new Header Field</h5>
            ...
            <div class="modal-body">
                <form action="{{route('headers.store')}}" method="post">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary">Store Header</button>
                    </div>
                </form>
            </div>
